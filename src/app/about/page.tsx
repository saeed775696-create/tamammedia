...
import { ArrowLeft, ArrowRight, Target, Lightbulb, HeartHandshake, CheckCircle2, Sparkles } from "lucide-react";
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="relative bg-[brand-900] pt-56 pb-48 min-h-[50vh] flex flex-col justify-center overflow-hidden">
        ...
        <div className="mx-auto max-w-[1200px] px-5 relative z-30 text-center">
          <span className="inline-flex items-center gap-2 py-2 px-6 bg-white/10 backdrop-blur-md border border-white/10 text-[accent-500] rounded-full text-sm font-bold mb-6 shadow-xl tracking-wide">
            <Sparkles size={16} />
            {isAr ? "تعرف على قصتنا" : "Get to know our story"}
          </span>
          ...
          <div className="flex items-center justify-center gap-3 text-sm font-semibold bg-white/5 backdrop-blur-sm px-6 py-3 rounded-full inline-flex mx-auto border border-white/5 shadow-lg">
            ...
            <span className="text-[accent-500] drop-shadow-md">{isAr ? "من نحن" : "About"}</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative z-10">
        <div className="mx-auto max-w-[1200px] px-5 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="order-1 lg:order-none rtl:text-right ltr:text-left">
              <span className="inline-block py-2 px-6 bg-[surface-100] text-[accent-500] rounded-full text-sm font-bold mb-6 border border-gray-100 shadow-sm">
                {isAr ? "شريكك الرقمي" : "Your Digital Partner"}
              </span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-[brand-900] mb-8 leading-snug md:leading-normal">
                {isAr ? "من نحن وماذا نمثل؟" : "Who we are and what we represent?"}
              </h2>
              
              <div className="space-y-6 text-gray-600 text-lg leading-[1.8] mb-12">
                <p>
                  {isAr
                ...
                <p className="font-medium text-[brand-900] text-xl md:text-2xl leading-relaxed">
                  {isAr
              ...
              <div className="flex flex-wrap gap-4 md:gap-5">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 bg-white px-5 py-3 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:border-[accent-500]/30 transition-colors duration-300">
                    <CheckCircle2 className="text-[accent-500] w-5 h-5 flex-shrink-0" />
                    <span className="font-bold text-[brand-900] text-sm">{feature}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-24 bg-slate-50 relative z-10">
        <div className="mx-auto max-w-[1200px] px-5 relative z-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            
            {/* Vision */}
            <div className="bg-white p-10 rounded-[2rem] shadow-[0_10px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-500 group border border-gray-100 hover:border-[accent-500]/30 flex flex-col items-start">
              <div className="w-16 h-16 bg-[accent-500] rounded-2xl flex items-center justify-center mb-8 shadow-lg">
                <Lightbulb className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-black text-[brand-900] mb-4 group-hover:text-[accent-500] transition-colors duration-300 leading-snug">
            ...
            {/* Mission */}
            <div className="relative z-10 bg-gradient-to-br from-[brand-900] to-[#3a3a7a] p-10 rounded-[2rem] shadow-[0_15px_50px_rgba(33,33,79,0.3)] group border border-[brand-900] hover:border-[accent-500] transition-all duration-500 flex flex-col items-start">
              ...
              <p className="text-gray-300 leading-[1.8] font-medium">
                {isAr
            ...
            <div className="bg-white p-10 rounded-[2rem] shadow-[0_10px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-500 group border border-gray-100 hover:border-[accent-500]/30 flex flex-col items-start">
              ...
              <ul className="text-gray-600 leading-[1.8] space-y-3 w-full">
      ...
      <section className="py-24 relative overflow-hidden bg-[var(--color-brand-900)] mt-16">
        ...
        <div className="mx-auto max-w-[1200px] px-5 relative z-10">
          <div className="max-w-4xl mx-auto text-center bg-white/5 backdrop-blur-xl border border-white/10 p-12 md:p-16 rounded-[3rem] shadow-2xl">
            ...
            <Link href="/contact" className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-[accent-500] text-white rounded-full font-bold text-lg hover:bg-[accent-600] hover:scale-105 hover:shadow-[0_10px_30px_-5px_rgba(218,136,39,0.5)] transition-all group">
              ...
              <ArrowLeft size={24} className={`transform transition-transform group-hover:-translate-x-2 ${isAr ? "" : "rotate-180 group-hover:translate-x-2 group-hover:-translate-x-0"}`} />
            </Link>
          </div>
        </div>
      </section>
