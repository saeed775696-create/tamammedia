        ...
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20">
            ...
            <div>
              ...
              <div className="flex items-start gap-4 p-5 md:p-6 bg-surface-50 rounded-2xl mb-5 transition-colors hover:bg-accent-500/5 border border-surface-100">
                ...
                <div>
                  ...
                  <a href={`mailto:${siteConfig.email}`} className="text-body text-surface-600 hover:text-accent-600 transition-colors">{siteConfig.email}</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-5 md:p-6 bg-surface-50 rounded-2xl mb-5 transition-colors hover:bg-accent-500/5 border border-surface-100">
                ...
                <div>
                  ...
                  <a href={`tel:+${siteConfig.phone}`} className="text-body text-surface-600 hover:text-accent-600 transition-colors" dir="ltr">{siteConfig.phoneDisplay}</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-5 md:p-6 bg-surface-50 rounded-2xl mb-5 transition-colors hover:bg-accent-500/5 border border-surface-100">
                ...
                <div>
                  ...
                  <p className="text-body text-surface-600">{lang === "ar" ? siteConfig.location.ar : siteConfig.location.en}</p>
                </div>
              </div>

              {/* روابط التواصل الاجتماعي */}
              <div className="flex items-center gap-3 mt-8">
                <a href={siteConfig.social.whatsapp} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-600 hover:bg-accent-500 hover:text-white transition-all" aria-label="WhatsApp">
                ...
                <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-600 hover:bg-accent-500 hover:text-white transition-all" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-600 hover:bg-accent-500 hover:text-white transition-all" aria-label="Instagram">
            ...
            {sent ? (
              ...
              <form className="card-base p-8 md:p-10" onSubmit={handleSubmit}>
