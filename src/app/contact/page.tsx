          ...
          <div className="contact-grid">
            ...
            <div>
              ...
              <div className="social-links">
                ...
                <a href="https://www.facebook.com/tamammedia" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.instagram.com/tamammedia" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
              ...
              <div className="map-container" style={{ marginTop: 20 }}>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d243646.8800000000!2d44.0197!3d13.5765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1601b4c8c0c0c0c1%3A0x0!2z2KfZhNiv2YrZitip!5e0!3m2!1sar!2s!4v1690000000000"
                  width="100%"
                  height="250"
