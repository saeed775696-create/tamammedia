  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <button
          onClick={openAdd}
          className="flex items-center gap-2 bg-[#da8827] text-white px-6 py-3 rounded-xl hover:bg-[#c07520] transition-all shadow-lg shadow-[#da8827]/30 font-medium"
        >
          <Plus size={20} />
          إضافة خدمة جديدة
        </button>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100">
          ...
          <button onClick={openAdd} className="mt-4 text-[#da8827] hover:underline font-medium">
            أضف خدمتك الأولى
          </button>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl my-8 overflow-hidden flex flex-col max-h-[90vh]">
            <div className="p-6 md:p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50">
              ...
              <button
                ...
                className="text-gray-400 hover:text-red-500 transition-colors p-2 bg-white rounded-full shadow-sm font-bold text-xl leading-none"
              >
                &times;
              </button>
            </div>
            ...
            <div className="p-6 md:p-8 overflow-y-auto flex-1 space-y-6">
              ...
              <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                <label className="block text-sm font-medium text-gray-700 mb-3">صورة أو أيقونة الخدمة</label>
                <div className="flex gap-3 items-center">
                  <label className="flex items-center gap-2 cursor-pointer bg-white hover:bg-gray-100 px-4 py-2 rounded-xl border transition">
                    <Plus size={16} />
                    اختر صورة
                  ...
                  <input
                    ...
                    className="flex-1 border border-gray-200 rounded-xl p-2 text-sm focus:ring-2 focus:ring-[#da8827] outline-none"
                  />
                </div>
                {form.imageUrl && (
                  <img src={form.imageUrl} alt="معاينة" className="mt-3 h-24 w-24 object-cover rounded-lg border" />
                )}
              </div>
