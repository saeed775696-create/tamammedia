  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {managedServices.length > 0 && (
        <section className="section-y-md border-t border-surface-100 bg-surface-50">
          <div className="container-site">
            <div className="section-header">
              <span className="section-eyebrow">
              ...
              <h2 className="text-h1 text-brand-900">
                {isAr ? "كل ما نقدمه لنجاحك" : "Everything We Offer"}
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
              {managedServices.map((service) => (
                <Link
                  ...
                  key={service.id}
                  className="group flex min-h-64 flex-col rounded-3xl border border-surface-200 bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-accent-300 hover:shadow-xl"
                >
                  <div className="mb-5 flex size-16 items-center justify-center overflow-hidden rounded-2xl bg-accent-50 text-accent-600">
                    {service.imageUrl ? (
                      <Image
                  ...
                  <h3 className="text-h4 text-brand-900 transition-colors group-hover:text-accent-600">
                    {isAr ? service.titleAr : service.titleEn}
                  </h3>
                  <p className="mt-3 line-clamp-3 flex-1 text-body leading-loose text-surface-600">
                    {isAr ? service.descriptionAr : service.descriptionEn}
                  </p>
                  <span className="mt-6 inline-flex items-center gap-2 text-sm font-extrabold text-brand-900 transition-colors group-hover:text-accent-600">
